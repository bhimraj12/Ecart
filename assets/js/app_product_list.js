...
$(document).on('change', '#maximum_quantity_1',  function(){
    ...
    if(Number(mini1) >= Number(maximum_quantity)){
     ...
     $("#minimum_quantity_3,#maximum_quantity_2,#maximum_quantity_3").val('');
     $("#row22col2,#row33col1,#row33col2" ).text('');
...
//       $.ajax({
//           type: 'POST',
//           url:  base_url + 'Productsseller/brandWithSubcategoryID',
//           data: {id:sid},
//           success:function(response){
        ...
        var result = confirm("Are You Sure?");
            ...
            if (result == true) {
                ...
                if(id !== 0){
                        ...
                        $.ajax({
                            type: 'POST',
                            url:  base_url + 'Productsseller/deletevariant',
...
$(document).ready(function(){      
    ...
    $(document).on('submit','#update_variant',function(e){
        e.preventDefault();
         $.ajax({
          type: 'POST',
          url:  base_url + 'Productsseller/updatevariant',
          data: $(this).serialize(),
          success:function(response){
              if(response == 0){
