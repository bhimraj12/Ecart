                ...
                $("#send-otp-button").html("Send OTP"), $(".send-otp-form").unblock(), window.signingIn = !1, updateSignInButtonUI(), resetRecaptcha(), $("#send-otp-form").hide(), $("#otp_div").show(), $("#verify-otp-form").removeClass("d-none"), $(document).on("submit", "#verify-otp-form", function (t) {
                    ...
                    $("#register_submit_btn").html("Please Wait...").attr("disabled", !0), e.confirm(a).then(function (e) {
                        r.append(csrfName, csrfHash), r.append("mobile", $("#phone-number").val()), r.append("country_code", $(".selected-dial-code").text()), $.ajax({
                            ...
                            success: function (e) {
                                csrfName = e.csrfName, csrfHash = e.csrfHash, $("#register_submit_btn").html("Submit").attr("disabled", !1), $("#registration-error").html(e.message).show();
                                $("#modal-signup").hide();
...
$(document).on("submit", ".form-submit-event", function (e) {
    ...
    t.append(csrfName, csrfHash), $.ajax({
        ...
        dataType: "json",
        success: function (e) {
            csrfName = e.csrfName, csrfHash = e.csrfHash, 1 == e.error ? (r.addClass("rounded p-3 alert alert-danger").removeClass("d-none alert-success"), r.show().delay(5e3).fadeOut(), r.html(e.message), s.html(n), s.attr("disabled", !1)) : (r.addClass("rounded p-3 alert alert-success").removeClass("d-none alert-danger"), r.show().delay(3e3).fadeOut(), r.html(e.message), s.html(n), s.attr("disabled", !1), $(".form-submit-event")[0].reset(), "login_form" == a && cart_sync(), setTimeout(function () {
                location.reload()
            }, 600))
        }
    })
                    ...
                    success: function (e) {
                        if (csrfName = e.csrfName, csrfHash = e.csrfHash, u.html(p).attr("disabled", !1), 0 == e.error) {
                            ...
                            $.each(e.data.items, function (e, t) {
                                ...
                                n += '<div class="shopping-cart"><div class="shopping-cart-item d-flex justify-content-between mb-4" title = "' + t.name + '"><div class="d-flex flex-row gap-3"><figure class="rounded cart-img"><a href="' + base_url + 'products/details/' + t.slug + '"><img src="' + base_url + t.image + '" alt="Not Found" style="object-fit: contain;"></a></figure><div class="w-100"><a href="' + base_url + 'products/details/' + t.slug + '"><h3 class="post-title fs-16 lh-xs mb-1" title = " ' + t.name + '">' + t.name + "</h3></a><span>" + t.product_variants + '</span><p class="price"><ins><span class="amount">' + currency + " " + a + '</span></ins></p><div class="product-pricing d-flex py-2 px-1 w-100"><div class="align-items-center d-flex p-2 w-15"><input type="number" name="header_qty" class="form-control d-flex align-items-center" value="' + c + '" data-id="' + t.product_variant_id + '" data-price="' + t.price + '" min="' + c + '" max="' + l + '" step="' + d + '" ></div><div class="product-line-price align-self-center px-1">' + currency + (t.qty * a) + '</div></div></div></div><div class="product-sm-removal"><button class="remove-product btn btn-sm btn-danger rounded-1 p-1 py-0" data-id="' + t.product_variant_id + '"><i class="uil uil-trash-alt"></i></button></div></div></div>'
    ...
    e = null !== localStorage.getItem("compare") ? e : null, $.ajax({
        ...
        success: function (t) {
            ...
            0 == t.error ? (null !== e && a > 0 && (r += '<div class="align-self-end mb-7"><div class="compare-removal"><button class="remove-compare btn btn-danger btn-sm" >Clear Compare</button></div></div></div><div><table class="compare-table table-bordered"><tbody><tr><th class="compare-field w-19"> </th>', $.each(t.data.product, function (e, t) {
                ...
                r += "</tr>", r += '<tr><th class="compare-field text-dark fs-17 text-center">Gurantee</th>', $.each(t.data.product, function (e, t) {
                ...
                r += "</tr>", r += '<tr><th class="compare-field text-dark fs-17 text-center">Cancelable</th>', $.each(t.data.product, function (e, t) {
...
$(document).ready(function () {
    $("#share").jsSocials({
        ...
        var t;
        e.preventDefault(), t = new firebase.auth.GoogleAuthProvider, firebase.auth().signInWithPopup(t).then(function (e) {
            var t = "google",
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function (e) {
                    csrfName = e.csrfName, csrfHash = e.csrfHash, console.log(e), 1 == e.error ? $.ajax({
                        type: "POST",
                        url: base_url + "auth/register_user",
                        data: {
                            type: t,
                        ...
                        dataType: "json",
                        success: function (e) {
                            csrfName = e.csrfName, csrfHash = e.csrfHash, 0 == e.error && $.ajax({
                                type: "POST",
            ...
            }), console.log("success msg"), console.log(e)
        }).catch(function (e) {
            console.log("error msg"), console.log(e)
        })
    }), $(document).on("click", "#facebookLogin", function (e) {
        var t;
        e.preventDefault(), t = new firebase.auth.FacebookAuthProvider, firebase.auth().signInWithPopup(t).then(function (e) {
            var t = "facebook",
                a = e.user.displayName,
        ...
        e.preventDefault(), firebase.auth().signOut().then(function () {
