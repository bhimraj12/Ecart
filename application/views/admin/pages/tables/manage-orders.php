                                ...
                                <table class='table-striped' id="digital_order_mail_table" data-toggle="table"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="message" data-sortable="false" data-visible="false">Message
                                            </th>
                                            <th data-field="file_url" data-sortable="false">URL</th>
                                            <th data-field="date_added" data-sortable="false" data-visible="false">Date
                                            </th>
                                        </tr>
                                    </thead>
                                </table>
                            ...
                            <div class="modal-body ">
                                <form class="form-horizontal form-submit-event"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="textarea" placeholder="Message for Email"
                                        ...
                                        <button type="submit" class="btn btn-success mt-3" id="submit_btn" value="Save">
                                            <?=labels('send_mail', 'Send Mail')?>
                                        </button>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <table class='table-striped' id="order_tracking_table" data-toggle="table"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="order_id" data-sortable="true">Order ID</th>
                                                <th data-field="order_item_id" data-sortable="false">Order Item ID</th>
                                                <th data-field="courier_agency" data-sortable="false">courier_agency
                                                </th>
                ...
                <div class="col-md-12 main-content">
                    <div class="card content-area p-4">
                        <div class="card-innr">
                            ...
                            <input type='hidden' id='order_user_id' value='<?=(isset($_GET[' user_id']) &&
                                !empty($_GET['user_id'])) ? $_GET['user_id'] : '' ?>'>
                            <input type='hidden' id='order_seller_id' value='<?=(isset($_GET[' seller_id']) &&
                                !empty($_GET['seller_id'])) ? $_GET['seller_id'] : '' ?>'>
                            ...
                            <div class="tab-content">
                                    ...
                                    <table class='table-striped' data-toggle="table"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="user_id" data-sortable='true' data-visible="false">User
                                                    ID</th>
                                                ...
                                                <th data-field="mobile" data-sortable='true' data-visible='false'>Mobile
                                                </th>
                                                <th data-field="notes" data-sortable='false' data-visible='true'>O.
                                                    Notes</th>
                                                <th data-field="items" data-sortable='true' data-visible="false">Items
                                                </th>
                                                <th data-field="total" data-sortable='true' data-visible="true">Total(
                                                    <?=$curreny?>)
                                                </th>
                                                ...
                                                <th data-field="wallet_balance" data-sortable='true'
                                                    data-visible="true">Wallet Used(
                                                    <?=$curreny?>)
                                                </th>
                                                <th data-field="promo_code" data-sortable='true' data-visible="false">
                                                    Promo Code</th>
                                                <th data-field="promo_discount" data-sortable='true'
                                                    data-visible="true">Promo disc.(
                                                    <?=$curreny?>)
                                                </th>
                                                ...
                                                <th data-field="delivery_date" data-sortable='true'
                                                    data-visible='false'>Delivery Date</th>
                                                <th data-field="delivery_time" data-sortable='true'
                                                    data-visible='false'>Delivery Time</th>
                                ...
                                <div id="cart_list_table" class="tab-pane fade">
                                    <table class='table-striped' data-toggle="table"
                                        data-url="<?=base_url('admin/customer/get_all_users_carts')?>"
                                        data-click-to-select="true" data-side-pagination="server" data-pagination="true"
                                        data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true"
                                        data-show-columns="true" data-show-refresh="true" data-trim-on-search="false"
                                        ...
                                        <thead>
                                            <tr>
                                                <th data-field="counter" data-sortable='true'
                                                    data-footer-formatter="totalFormatter">ID</th>
                                                <th data-field="id" data-visible="true" data-sortable="true">Cart Id
                                                </th>
                                                <th data-field="name" data-visible="true" data-sortable="true">Product
                                                    Name</th>
                                                <th data-field="qty" data-visible="true" data-sortable="true">Quantity
                                                </th>
                                                <th data-field="username" data-visible="true" data-sortable="true">User
                                                    Name</th>
                                                <th data-field="email" data-visible="true" data-sortable="true">Email
                                                </th>
                                                <th data-field="mobile" data-visible="true" data-sortable="true">Mobile
                                                </th>
                                                <th data-field="date_created" data-visible="true" data-sortable="true">
                                                    Added</th>
                                            </tr>
                                        </thead>
    ...
    function populateCartList(cartList) {
        ...
        if (cartList && Array.isArray(cartList)) {
            if (cartList.length > 0) {
                var counter = 1; // Counter for sequential numbers
